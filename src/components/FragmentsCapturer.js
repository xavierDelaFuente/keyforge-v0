...
const FragmentsCapturer = ({ id, fragments, counterValue, resetCounter, captureFragments, incrementCounter, decrementCounter }) => {
      ...
      <div data-testid="fragments-captured">
        ...
        <div>{fragments}</div>
			...
			<Counter
				...
				value={counterValue}
			/>
			<button onClick={() => captureFragmentsFromPlayer(counterValue, id)} data-testid="steal-fragments">
				Captured Fragments
			</button>
		</div>
	);
